...
spark = SparkSession.builder.appName("vz_ingestion_care_chat_interaction_136").getOrCreate()
job_id = 136
...
lineage_df = spark.createDataFrame(
    [(136, "vz_ingestion_care_chat_interaction", "ftr_raw.care_chat_interaction", "vz_curated.care_chat_interaction_ingestion", "care", "ingestion", "pyspark")],
