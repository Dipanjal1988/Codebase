...
DECLARE v_job_id INT64 DEFAULT 443;
CREATE TEMP TABLE stg_network_outage_event_443 AS
SELECT
  s.site_id,
       s.cell_id,
       s.node_id,
...
SELECT * FROM stg_network_outage_event_443;
...
VALUES (443, 'vz_aggregation_network_outage_event', '`vz-agentic-198889.ftr_raw.network_outage_event`', '`vz-agentic-198889.vz_curated.network_outage_event_aggregation`', 'network', 'aggregation', 'bigquery_sql', CURRENT_TIMESTAMP());
