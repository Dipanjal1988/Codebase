...
CREATE OR REPLACE TEMP VIEW stg_usage_cdr_data_115 AS
SELECT
  s.usage_id,
       s.customer_id,
       s.msisdn,
...
USING stg_usage_cdr_data_115 s
...
SELECT 115, 'vz_validation_usage_cdr_data', 'ftr_raw.usage_cdr_data', 'vz_curated.usage_cdr_data_validation', 'usage', 'validation', 'spark_sql', CURRENT_TIMESTAMP;
