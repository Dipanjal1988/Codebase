...
CREATE OR REPLACE TEMP VIEW stg_orders_fulfillment_event_274 AS
SELECT
  s.order_id,
       s.order_line_id,
       s.customer_id,
...
USING stg_orders_fulfillment_event_274 s
...
SELECT 274, 'vz_scheduling_orders_fulfillment_event', 'ftr_raw.orders_fulfillment_event', 'vz_curated.orders_fulfillment_event_scheduling', 'orders', 'scheduling', 'snowflake_sql', CURRENT_TIMESTAMP;
