...
CREATE OR REPLACE TEMP VIEW stg_orders_activation_order_344 AS
SELECT
  s.order_id,
       s.order_line_id,
       s.customer_id,
...
USING stg_orders_activation_order_344 s
...
SELECT 344, 'vz_scheduling_orders_activation_order', 'ftr_raw.orders_activation_order', 'vz_curated.orders_activation_order_scheduling', 'orders', 'scheduling', 'snowflake_sql', CURRENT_TIMESTAMP;
