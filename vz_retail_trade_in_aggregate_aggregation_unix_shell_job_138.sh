#!/bin/bash
# FILE_NAME_CONTEXT: Verizon retail.trade_in aggregation lineage job
# JOB_ID: 138
# JOB_TYPE: aggregation
# DIALECT: unix_shell
# SOURCE_OBJECT: ftr_raw.retail_trade_in
# TARGET_OBJECT: vz_curated.retail_trade_in_aggregation
set -euo pipefail
JOB_ID="138"
JOB_NAME="vz_aggregation_retail_trade_in"
LANDING="gs://vz-ftr-landing/retail/trade_in"
ARCHIVE="gs://vz-ftr-archive/retail/trade_in"
RAW_TABLE="vz-agentic-198889:ftr_raw.retail_trade_in"
...
CREATE OR REPLACE TABLE `vz-agentic-198889.vz_curated.retail_trade_in_aggregation` AS
SELECT *, CURRENT_TIMESTAMP() AS lineage_load_ts, 138 AS lineage_job_id
FROM `vz-agentic-198889.ftr_raw.retail_trade_in`
...
VALUES(138, '$JOB_NAME', 'ftr_raw.retail_trade_in', 'vz_curated.retail_trade_in_aggregation', 'retail', 'aggregation', 'unix_shell', CURRENT_TIMESTAMP());
SQL
