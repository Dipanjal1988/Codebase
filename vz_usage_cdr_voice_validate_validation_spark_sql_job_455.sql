...
CREATE OR REPLACE TEMP VIEW stg_usage_cdr_voice_455 AS
SELECT
  s.usage_id,
       s.customer_id,
       s.msisdn,
...
USING stg_usage_cdr_voice_455 s
...
SELECT 455, 'vz_validation_usage_cdr_voice', 'ftr_raw.usage_cdr_voice', 'vz_curated.usage_cdr_voice_validation', 'usage', 'validation', 'spark_sql', CURRENT_TIMESTAMP;
