...
spark = SparkSession.builder.appName("vz_ingestion_care_case_header_406").getOrCreate()
job_id = 406
...
lineage_df = spark.createDataFrame(
    [(406, "vz_ingestion_care_case_header", "ftr_raw.care_case_header", "vz_curated.care_case_header_ingestion", "care", "ingestion", "pyspark")],
