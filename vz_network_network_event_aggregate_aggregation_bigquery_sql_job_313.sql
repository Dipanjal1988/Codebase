...
DECLARE v_job_id INT64 DEFAULT 313;
CREATE TEMP TABLE stg_network_network_event_313 AS
SELECT
  s.site_id,
       s.cell_id,
       s.node_id,
...
SELECT * FROM stg_network_network_event_313;
...
VALUES (313, 'vz_aggregation_network_network_event', '`vz-agentic-198889.ftr_raw.network_network_event`', '`vz-agentic-198889.vz_curated.network_network_event_aggregation`', 'network', 'aggregation', 'bigquery_sql', CURRENT_TIMESTAMP());
