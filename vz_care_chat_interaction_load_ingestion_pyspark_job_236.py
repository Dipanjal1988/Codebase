# FILE_NAME_CONTEXT: Verizon care.chat_interaction ingestion lineage job
# JOB_ID: 236
# JOB_TYPE: ingestion
# DIALECT: pyspark
# SOURCE_OBJECT: ftr_raw.care_chat_interaction
# TARGET_OBJECT: vz_curated.care_chat_interaction_ingestion
from pyspark.sql import SparkSession
from pyspark.sql.functions import col, lit, current_timestamp, sha2, concat_ws, coalesce, count

spark = SparkSession.builder.appName("vz_ingestion_care_chat_interaction_236").getOrCreate()
job_id = 236
source_path = "gs://vz-ftr-landing/care/chat_interaction/"
target_path = "gs://vz-curated/care/chat_interaction_ingestion/"
...
summary_df.write.format("bigquery").option("table", "vz-agentic-198889.vz_mart.care_chat_interaction_ingestion_summary").mode("append").save()

lineage_df = spark.createDataFrame(
    [(236, "vz_ingestion_care_chat_interaction", "ftr_raw.care_chat_interaction", "vz_curated.care_chat_interaction_ingestion", "care", "ingestion", "pyspark")],
