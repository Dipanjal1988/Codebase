...
DECLARE v_job_id INT64 DEFAULT 3;
CREATE TEMP TABLE stg_network_cell_site_3 AS
SELECT
  s.site_id,
       s.cell_id,
       s.node_id,
...
SELECT * FROM stg_network_cell_site_3;
...
VALUES (3, 'vz_aggregation_network_cell_site', '`vz-agentic-198889.ftr_raw.network_cell_site`', '`vz-agentic-198889.vz_curated.network_cell_site_aggregation`', 'network', 'aggregation', 'bigquery_sql', CURRENT_TIMESTAMP());
