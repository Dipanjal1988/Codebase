...
spark = SparkSession.builder.appName("vz_ingestion_care_chat_interaction_286").getOrCreate()
job_id = 286
...
lineage_df = spark.createDataFrame(
    [(286, "vz_ingestion_care_chat_interaction", "ftr_raw.care_chat_interaction", "vz_curated.care_chat_interaction_ingestion", "care", "ingestion", "pyspark")],
