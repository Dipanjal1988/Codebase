...
spark = SparkSession.builder.appName("vz_ingestion_care_ivr_event_176").getOrCreate()
job_id = 176
...
lineage_df = spark.createDataFrame(
    [(176, "vz_ingestion_care_ivr_event", "ftr_raw.care_ivr_event", "vz_curated.care_ivr_event_ingestion", "care", "ingestion", "pyspark")],
