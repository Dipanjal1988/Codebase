...
DECLARE v_job_id INT64 DEFAULT 153;
CREATE TEMP TABLE stg_network_cell_site_153 AS
SELECT
  s.site_id,
       s.cell_id,
       s.node_id,
...
SELECT * FROM stg_network_cell_site_153;
...
VALUES (153, 'vz_aggregation_network_cell_site', '`vz-agentic-198889.ftr_raw.network_cell_site`', '`vz-agentic-198889.vz_curated.network_cell_site_aggregation`', 'network', 'aggregation', 'bigquery_sql', CURRENT_TIMESTAMP());
