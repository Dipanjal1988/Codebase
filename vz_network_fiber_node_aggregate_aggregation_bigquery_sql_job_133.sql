...
DECLARE v_job_id INT64 DEFAULT 133;
CREATE TEMP TABLE stg_network_fiber_node_133 AS
SELECT
  s.site_id,
       s.cell_id,
       s.node_id,
...
SELECT * FROM stg_network_fiber_node_133;
...
VALUES (133, 'vz_aggregation_network_fiber_node', '`vz-agentic-198889.ftr_raw.network_fiber_node`', '`vz-agentic-198889.vz_curated.network_fiber_node_aggregation`', 'network', 'aggregation', 'bigquery_sql', CURRENT_TIMESTAMP());
