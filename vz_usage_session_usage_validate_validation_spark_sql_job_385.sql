...
CREATE OR REPLACE TEMP VIEW stg_usage_session_usage_385 AS
SELECT
  s.usage_id,
       s.customer_id,
       s.msisdn,
...
USING stg_usage_session_usage_385 s
...
SELECT 385, 'vz_validation_usage_session_usage', 'ftr_raw.usage_session_usage', 'vz_curated.usage_session_usage_validation', 'usage', 'validation', 'spark_sql', CURRENT_TIMESTAMP;
