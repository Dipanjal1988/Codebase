...
spark = SparkSession.builder.appName("vz_ingestion_care_chat_interaction_486").getOrCreate()
job_id = 486
...
lineage_df = spark.createDataFrame(
    [(486, "vz_ingestion_care_chat_interaction", "ftr_raw.care_chat_interaction", "vz_curated.care_chat_interaction_ingestion", "care", "ingestion", "pyspark")],
