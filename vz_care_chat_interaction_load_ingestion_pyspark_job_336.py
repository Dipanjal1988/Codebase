...
spark = SparkSession.builder.appName("vz_ingestion_care_chat_interaction_336").getOrCreate()
job_id = 336
...
lineage_df = spark.createDataFrame(
    [(336, "vz_ingestion_care_chat_interaction", "ftr_raw.care_chat_interaction", "vz_curated.care_chat_interaction_ingestion", "care", "ingestion", "pyspark")],
