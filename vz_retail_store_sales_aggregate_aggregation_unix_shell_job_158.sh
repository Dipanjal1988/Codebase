...
SELECT *, CURRENT_TIMESTAMP() AS lineage_load_ts, 158 AS lineage_job_id
...
VALUES(158, '$JOB_NAME', 'ftr_raw.retail_store_sales', 'vz_curated.retail_store_sales_aggregation', 'retail', 'aggregation', 'unix_shell', CURRENT_TIMESTAMP());
SQL
