# FILE_NAME_CONTEXT: Verizon care.ivr_event ingestion lineage job
# JOB_ID: 326
# JOB_TYPE: ingestion
# DIALECT: pyspark
# SOURCE_OBJECT: ftr_raw.care_ivr_event
# TARGET_OBJECT: vz_curated.care_ivr_event_ingestion
from pyspark.sql import SparkSession
from pyspark.sql.functions import col, lit, current_timestamp, sha2, concat_ws, coalesce, count

spark = SparkSession.builder.appName("vz_ingestion_care_ivr_event_326").getOrCreate()
job_id = 326
source_path = "gs://vz-ftr-landing/care/ivr_event/"
target_path = "gs://vz-curated/care/ivr_event_ingestion/"
...
summary_df.write.format("bigquery").option("table", "vz-agentic-198889.vz_mart.care_ivr_event_ingestion_summary").mode("append").save()

lineage_df = spark.createDataFrame(
    [(326, "vz_ingestion_care_ivr_event", "ftr_raw.care_ivr_event", "vz_curated.care_ivr_event_ingestion", "care", "ingestion", "pyspark")],
