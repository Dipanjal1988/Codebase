...
spark = SparkSession.builder.appName("vz_ingestion_care_case_header_356").getOrCreate()
job_id = 356
...
lineage_df = spark.createDataFrame(
    [(356, "vz_ingestion_care_case_header", "ftr_raw.care_case_header", "vz_curated.care_case_header_ingestion", "care", "ingestion", "pyspark")],
