...
spark = SparkSession.builder.appName("vz_ingestion_care_ivr_event_76").getOrCreate()
job_id = 76
...
lineage_df = spark.createDataFrame(
    [(76, "vz_ingestion_care_ivr_event", "ftr_raw.care_ivr_event", "vz_curated.care_ivr_event_ingestion", "care", "ingestion", "pyspark")],
