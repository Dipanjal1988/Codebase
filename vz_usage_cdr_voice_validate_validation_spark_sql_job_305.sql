...
CREATE OR REPLACE TEMP VIEW stg_usage_cdr_voice_305 AS
SELECT
  s.usage_id,
       s.customer_id,
       s.msisdn,
...
USING stg_usage_cdr_voice_305 s
...
SELECT 305, 'vz_validation_usage_cdr_voice', 'ftr_raw.usage_cdr_voice', 'vz_curated.usage_cdr_voice_validation', 'usage', 'validation', 'spark_sql', CURRENT_TIMESTAMP;
