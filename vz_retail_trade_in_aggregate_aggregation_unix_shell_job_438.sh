...
SELECT *, CURRENT_TIMESTAMP() AS lineage_load_ts, 438 AS lineage_job_id
...
VALUES(438, '$JOB_NAME', 'ftr_raw.retail_trade_in', 'vz_curated.retail_trade_in_aggregation', 'retail', 'aggregation', 'unix_shell', CURRENT_TIMESTAMP());
SQL
