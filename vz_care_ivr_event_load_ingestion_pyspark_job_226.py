...
spark = SparkSession.builder.appName("vz_ingestion_care_ivr_event_226").getOrCreate()
job_id = 226
...
lineage_df = spark.createDataFrame(
    [(226, "vz_ingestion_care_ivr_event", "ftr_raw.care_ivr_event", "vz_curated.care_ivr_event_ingestion", "care", "ingestion", "pyspark")],
