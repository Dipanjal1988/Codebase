...
CREATE OR REPLACE TEMP VIEW stg_orders_order_header_54 AS
SELECT
  s.order_id,
       s.order_line_id,
       s.customer_id,
...
USING stg_orders_order_header_54 s
...
SELECT 54, 'vz_scheduling_orders_order_header', 'ftr_raw.orders_order_header', 'vz_curated.orders_order_header_scheduling', 'orders', 'scheduling', 'snowflake_sql', CURRENT_TIMESTAMP;
