...
CREATE OR REPLACE TEMP VIEW stg_usage_roaming_usage_445 AS
SELECT
  s.usage_id,
       s.customer_id,
       s.msisdn,
...
USING stg_usage_roaming_usage_445 s
...
SELECT 445, 'vz_validation_usage_roaming_usage', 'ftr_raw.usage_roaming_usage', 'vz_curated.usage_roaming_usage_validation', 'usage', 'validation', 'spark_sql', CURRENT_TIMESTAMP;
