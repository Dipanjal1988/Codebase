...
DECLARE v_job_id INT64 DEFAULT 183;
CREATE TEMP TABLE stg_network_fiber_node_183 AS
SELECT
  s.site_id,
       s.cell_id,
       s.node_id,
...
SELECT * FROM stg_network_fiber_node_183;
...
VALUES (183, 'vz_aggregation_network_fiber_node', '`vz-agentic-198889.ftr_raw.network_fiber_node`', '`vz-agentic-198889.vz_curated.network_fiber_node_aggregation`', 'network', 'aggregation', 'bigquery_sql', CURRENT_TIMESTAMP());
