...
CREATE OR REPLACE TEMP VIEW stg_usage_cdr_sms_425 AS
SELECT
  s.usage_id,
       s.customer_id,
       s.msisdn,
...
SELECT 425, 'vz_validation_usage_cdr_sms', 'ftr_raw.usage_cdr_sms', 'vz_curated.usage_cdr_sms_validation', 'usage', 'validation', 'spark_sql', CURRENT_TIMESTAMP;
